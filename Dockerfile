...
RUN set -x && \
	...
	curl -Lk https://github.com/xiaoyawl/centos_init/raw/master/nginx-mode.tar.gzhttps://github.com/xiaoyawl/centos_init/raw/master/nginx-mode.tar.gz|tar xz -C ${TEMP_DIR} && \
